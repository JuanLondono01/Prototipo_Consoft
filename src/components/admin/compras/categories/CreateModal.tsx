import { CategoryProps, DefaultModalProps, InputTypes, ProductProps } from '@/types/types';
import React from 'react';
import { IoMdClose } from 'react-icons/io';
import InputForm from '../../global/InputForm';

function CreateModal({ isOpen, onClose, extraProps }: DefaultModalProps<CategoryProps>) {
    if (!isOpen) return;
    return (
